...
public class SettlementFlowIntegrationTest {
        ...
        void settlementShouldNotReduceBalanceUntilConfirmed() throws Exception {
                ...
                // ---------- SIGN IN USERS ----------
                String tokenUser1 = extractToken(
                                client.postForEntity(base + "/api/auth/signin", signupUser1Req, String.class));
                String tokenUser2 = extractToken(
                                client.postForEntity(base + "/api/auth/signin", signupUser2Req, String.class));
                String tokenOutsider = extractToken(
                                client.postForEntity(base + "/api/auth/signin", signupOutsiderReq, String.class));
                ...
                List<Map<String, Object>> initialBalances = (List<Map<String, Object>>) initialBalanceMap
                                .get("balances");
                ...
                Map<String, Object> settlementMap = mapper.readValue(createSettlementResp.getBody(),
                                new TypeReference<>() {
                                });
                ...
                List<Map<String, Object>> incomingSettlements = mapper.readValue(incomingResp.getBody(),
                                new TypeReference<>() {
                                });
                ...
                List<Map<String, Object>> outgoingSettlements = mapper.readValue(outgoingResp.getBody(),
                                new TypeReference<>() {
                                });
                ...
                List<Map<String, Object>> pendingBalances = (List<Map<String, Object>>) pendingBalanceMap
                                .get("balances");
                ...
                Map<String, Object> confirmedSettlementMap = mapper.readValue(confirmResp.getBody(),
                                new TypeReference<>() {
                                });
                ...
                List<Map<String, Object>> confirmedBalances = (List<Map<String, Object>>) confirmedBalanceMap
                                .get("balances");
                ...
                Map<String, Object> rejectedSettlementMap = mapper.readValue(rejectResp.getBody(),
                                new TypeReference<>() {
                                });

                assertThat(rejectedSettlementMap.get("status").toString()).isEqualTo("REJECTED");
                assertThat(rejectedSettlementMap.get("rejectionReason").toString())
                                .isEqualTo("I did not receive this payment");
                ...
                List<Map<String, Object>> rejectedBalances = (List<Map<String, Object>>) rejectedBalanceMap
                                .get("balances");
                ...
                List<Map<String, Object>> history = mapper.readValue(historyResp.getBody(), new TypeReference<>() {
                });
        ...
        private Map<String, Object> getBalanceMap(
                        ...
                        String base,
                        UUID groupId,
                        HttpHeaders authHeaders) throws Exception {
