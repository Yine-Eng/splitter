...
public class GroupMembershipAccessIntegrationTest {
    ...
    void groupMembershipAndAccessFlow() throws Exception {
        ...
        Map<String, Object> addedMemberMap =
                mapper.readValue(addMemberResp.getBody(), new TypeReference<>() {});
        ...
        List<Map<String, Object>> members =
                mapper.readValue(memberListResp.getBody(), new TypeReference<>() {});
        ...
        List<Map<String, Object>> expenses =
                mapper.readValue(memberExpensesResp.getBody(), new TypeReference<>() {});
        ...
        List<Map<String, Object>> adminGroups =
                mapper.readValue(adminGroupsResp.getBody(), new TypeReference<>() {});
        ...
        List<Map<String, Object>> outsiderGroups =
                mapper.readValue(outsiderGroupsResp.getBody(), new TypeReference<>() {});
